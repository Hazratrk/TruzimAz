document.addEventListener('DOMContentLoaded', function() {
    // Get apartment ID from URL query parameter
    ...
    // Fetch apartment data from your JSON
    fetch('db.json') // Replace with your actual JSON file path
    ...
    container.innerHTML = `
      ...
      <div class="p-6">
        ...
        <div class="mt-10 flex justify-center">
          <button class="bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-10 rounded-lg transition duration-300 shadow-md">
            Book Now
          </button>
        </div>
      </div>
