            ...
            if (rentals.length === 0) {
                rentalsContainer.innerHTML = `
                    <div class="text-center py-8">
                        ...
                        <a href="apartments.html" class="mt-4 inline-block bg-blue-600 text-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">
                            Apartamentlərə bax
                        </a>
                    </div>
                `;
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50 ">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-blue-500 uppercase tracking-wider">Apartament</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-blue-500 uppercase tracking-wider">Tarix</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-blue-500 uppercase tracking-wider">Qiymət</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-blue-500 uppercase tracking-wider">Status</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white text-blue-500 divide-y divide-gray-200">
            `;
